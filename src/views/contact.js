      ...
      <div className={styles['Contact']}>
        <div className={styles['container04']}>
          <div className={styles['Form']}>
            <h2
              className={` ${styles['text11']} ${projectStyles['headingOne']} `}
            >
              <span>Say Hi!</span>
            </h2>
            <span className={` ${styles['text13']} ${projectStyles['lead']} `}>
              We&apos;d like to talk with you.
            </span>
            <form className={styles['form1']}>
              <label
                className={` ${styles['text14']} ${projectStyles['label']} `}
              >
                My name is
              </label>
              <input
              ...
              />
              <label
                className={` ${styles['text15']} ${projectStyles['label']} `}
              >
                I&apos;m looking for
              </label>
              <input
              ...
              />
              <label
                className={` ${styles['text16']} ${projectStyles['label']} `}
              >
                Your message
              </label>
              <textarea
